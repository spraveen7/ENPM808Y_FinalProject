...
namespace fp {
    ...
    public:
         ...
         * @return Returns none
         */
        void MoveForward(int x, int y) override;     //--Moves the robot forward
         ...
         * @return Returns none
         */
        void TurnLeft(int x, int y) override;       //--Rotates the robot 90°counter-clockwise
...
#endif //FINAL_PROJECT_LANDBASEDTRACKED_H
